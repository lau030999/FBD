...
RESULTADOS="/home/laura/Documentos/FBD/tarea3/TYVS/resultados/test_cool_4.txt"
...
do
  ...
  # Iniciar el servicio de PostgreSQL
    ...
    tiempo=$( { time psql -d tareafbd -U laura -h localhost -c "SELECT category_id, COUNT(*) AS cantidad_videos FROM tablaunion GROUP BY category_id ORDER BY cantidad_videos DESC LIMIT 1;"  ; } 2>&1 )
