...
RESULTADOS="/home/laura/Documentos/FBD/tarea3/TYVS/resultados/test_cool_2.txt"
...
do
  ...
  # Iniciar el servicio de PostgreSQL
    ...
    tiempo=$( { time psql -d tareafbd -U laura -h localhost -c "SELECT title, TO_CHAR(publish_time, 'YY-MM-DD') AS publish_date FROM tablaunion ORDER BY publish_time LIMIT 1;"  ; } 2>&1 )
